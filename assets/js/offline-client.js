(function () {
    ...
    function installUi() {
        ...
        style.textContent = `
            ...
            .naap-offline-modal-backdrop{position:fixed;inset:0;background:#0009;z-index:100001;display:grid;place-items:center;padding:24px}.naap-offline-modal{box-sizing:border-box;width:min(780px,100%);min-width:0;max-height:calc(100dvh - 48px);overflow:auto;overscroll-behavior:contain;background:#fff;color:#172033;border-radius:16px;padding:28px;box-shadow:0 20px 60px #0008;font-family:system-ui}.naap-offline-modal h2,.naap-offline-modal p,.naap-offline-modal li{overflow-wrap:anywhere}.naap-offline-modal h2{margin:0 0 12px}.naap-offline-activity-list{list-style:none;padding:0;margin:16px 0;max-height:62vh;overflow:auto;overscroll-behavior:contain}.naap-offline-modal-actions{position:sticky;bottom:-28px;background:#fff;display:flex;flex-wrap:wrap;gap:10px;margin:20px -28px -28px;padding:16px 28px 28px;border-top:1px solid #e5e7eb}.naap-offline-modal button{max-width:100%;border:0;border-radius:8px;padding:10px 14px;font-weight:700;cursor:pointer}.naap-offline-sync{background:#0b4b86;color:#fff}.naap-offline-stay{background:#e5e7eb}.naap-offline-delete{background:#b91c1c;color:#fff}.naap-offline-modal button:disabled{opacity:.5;cursor:not-allowed}@media(max-width:640px){.naap-offline-modal-backdrop{padding:10px}.naap-offline-modal{max-height:calc(100dvh - 20px);border-radius:12px;padding:18px}.naap-offline-modal-actions{bottom:-18px;margin:16px -18px -18px;padding:14px 18px 18px}}@media(max-width:420px){.naap-offline-modal-actions{align-items:stretch;flex-direction:column}.naap-offline-modal-actions button{width:100%}}

...
<body data-org-read-only="<?= !empty($session['is_read_only']) ? '1' : '0' ?>">
    ...
    <script src="../../systems/IGPRentalSystem/lib/JsBarcode.all.min.js?v=20260927-complete-ui-1"></script>
    ...
    <script src="../../systems/IGPRentalSystem/lib/encoder.js?v=20260927-complete-ui-1"></script>
    <script src="../../assets/js/igp-api.js?v=20260927-complete-ui-1"></script>
    <script src="../../assets/js/barcode-download.js?v=20260927-complete-ui-1"></script>
    <script src="../../assets/js/igp-students-exact.js?v=20260927-complete-ui-1"></script>

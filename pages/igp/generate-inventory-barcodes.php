...
<body data-org-read-only="<?= !empty($session['is_read_only']) ? '1' : '0' ?>">
    ...
    <script src="../../systems/IGPRentalSystem/lib/jszip.min.js?v=20260927-complete-ui-1"></script>
    ...
    <script src="../../assets/js/igp-barcodes-exact.js?v=20260927-complete-ui-1"></script>

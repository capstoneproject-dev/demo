...
function splitStudentProfileName(string $fullName): array
{
...
[$firstName, $lastName] = splitStudentProfileName($fullName);
$pdo = getPdo();
...
try {
    ...
    error_log('[api/student/profile/update] ' . $e->getMessage());

...
function orgProfileStoreImage(string $field, int $orgId): ?string
{
...
try {
    ...
    $bannerUrl = orgProfileStoreImage('bannerFile', $orgId) ?: ($existing['banner_url'] ?? null);
    $logoUrl = orgProfileStoreImage('logoFile', $orgId) ?: ($existing['logo_url'] ?? null);
